    ...
    return Scaffold(
      drawer: Drawer(
        ...
        children: [
          UserAccountsDrawerHeader(
            decoration: BoxDecoration(image: DecorationImage(image: AssetImage("assets/img/pk.jpg"),fit: BoxFit.cover),),
      ...
      children: [
        Container(
          ...
          Padding(padding: const EdgeInsets.only(right: 12),child: Text("\$ 128"),)
            ],
          )
        ],
      ),
